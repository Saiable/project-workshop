  ...
  # 绘制小标题
    ...
    def draw_table(*args):
        ...
        style = [
            ...
            ('FONTSIZE', (0, 0), (-1, 0), 10),  # 第一行的字体大小 12
            ('FONTSIZE', (0, 1), (-1, -1), 10),  # 第二行到最后一行的字体大小 10
            # ('BACKGROUND', (0, 0), (-1, 0), '#d5dae6'),  # 设置第一行背景颜色
            ('ALIGN', (0, 0), (-1, -1), 'LEFT'),  # 第一行水平居中 CENTER
            ('ALIGN', (0, 1), (-1, -1), 'LEFT'),  # 第二行到最后一行左右左对齐
            ('VALIGN', (0, 0), (-1, -1), 'MIDDLE'),  # 所有表格上下居中对齐
            ('TEXTCOLOR', (0, 0), (-1, -1), colors.darkslategray),  # 设置表格内文字颜色
            ('INNERGRID', (0, 0), (-1, -1), 0.5, colors.transparent),  # 设置为透明无边框。设置表格框线为grey色，线宽为0.5。GRID INNERGRID
...
if __name__ == '__main__':
    ...
    data1 = [
        ('甲方：设置为透明无边框。设置表格框线为grey色，线宽为0.5。GRID INNERGRID', '乙方：456456'),
        ('甲方：设置为透明无边框。设置表格框线为\ngrey色，线宽为0.5。GRID INNERGRID', '2b'),
        ('1a11', '2b'),
        ('1a22', '2b')
    ]
