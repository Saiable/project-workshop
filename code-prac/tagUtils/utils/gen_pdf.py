...
pdfmetrics.registerFont(TTFont('SimSun', './SimSun.ttf'))  # 默认不支持中文，需要注册字体 # https://www.onlinedown.net/soft/10033540.htm
pdfmetrics.registerFont(TTFont('SimSunBd', './SimSunBold.ttf'))
...
content2 = "区块链起源于比特币，2008年11月1日，一位自称中本聪(SatoshiNakamoto)的人发表了《比特币:一种点对点的电子现金系统》" \
           ...
           "0的创世区块相连接形成了链，标志着区块链的诞生 [5]  。<br/><img src='./png/1.png' width=180 height=100 valign='top'/><br/><br/><br/><br/><br/>"
...
F = ['甲方', '乙方']
# story.append(BalancedColumns(F))
